...
Reference documentation for the tooling shipped by **@brnshkr/config**, organized by stack and tool.
Installation and the ways to run each tool live in the [README](../README.md)
