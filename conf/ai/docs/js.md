...
- Custom ESLint rules live in `src/js/eslint/configs/builtin/` (kebab-case file per rule); user docs per rule in `docs/js/eslint/rules/`. New rule = implementation + doc page + snapshot update.
