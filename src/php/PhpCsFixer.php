...
final readonly class PhpCsFixer
{
    ...
    public static function getConfig(?Finder $finder = null): PhpCsFixerConfig
    {
        ...
        $rules = [
            ...
            'phpdoc_separation'                 => ['groups' => [['filesource'], ['api', 'internal'], ['ignore'], ['deprecated', 'since', 'todo', 'version'], ['author', 'copyright', 'license'], ['category', 'package', 'subpackage'], ['phpstan-type', 'phpstan-import-type'], ['phpstan-template', 'phpstan-template-covariant', 'phpstan-template-contravariant'], ['phpstan-extends', 'phpstan-implements', 'phpstan-use'], ['phpstan-require-extends', 'phpstan-require-implements'], ['phpstan-consistent-constructor', 'phpstan-immutable', 'phpstan-pure', 'phpstan-impure', 'phpstan-readonly', 'phpstan-readonly-allow-private-mutation', 'phpstan-allow-private-mutation'], ['uses'], ['name'], ['method', 'phpstan-method'], ['property', 'phpstan-property', 'property-read', 'phpstan-property-read', 'property-write', 'phpstan-property-write'], ['abstract', 'access', 'final', 'static'], ['global', 'staticvar', 'var', 'phpstan-var'], ['param', 'phpstan-param', 'phpstan-param-out', 'phpstan-param-immediately-invoked-callable', 'phpstan-param-later-invoked-callable', 'phpstan-param-closure-this'], ['return', 'phpstan-return'], ['throws', 'phpstan-throws'], ['phpstan-assert', 'phpstan-assert-if-true', 'phpstan-assert-if-false', 'phpstan-self-out', 'phpstan-this-out'], ['link', 'see', 'tutorial'], ['example']]],
